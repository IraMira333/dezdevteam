...
export const Hero = () => {
  ...
  return (
    <section className="nopadding-container tab:px-6 prepc:px-10 pc:px-20 overflow-hidden">
      <div className="tab:flex tab:pb-16 prepc:pt-20 pc:mt-26 tab:justify-between min-h-[calc(100vh-77px)] pt-17.5">
        ...
        <div className="tab:w-[56%] tab:max-w-157 tab:mb-0 tab:ml-auto tab:mr-0 relative mx-auto aspect-[125/100] h-auto w-full">
          <FloatingGallery />
