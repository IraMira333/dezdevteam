...
export const Offer = () => {
  ...
  return (
    <section className="bg-black0a casual-container pc:min-w-fit relative min-h-[calc(100vh-77px)] min-w-screen">
      ...
      <div className="tab:pt-14 prepc:pt-6 prepc:pb-16 pc:pb-23.5 tab:w-[calc(100%-48px)] prepc:w-[calc(100%-80px)] pc:w-[calc(100%-160px)] relative z-1 flex h-full w-[calc(100%-32px)] flex-col justify-between gap-6 pt-28.5 pb-14">
